...
namespace SparkleShare {
    ...
    public class SparkleSetup : SparkleSetupWindow {
        ...
        private string SecondaryTextColor = "#ff000";//SparkleUIHelpers.GdkColorToHex (Style.Foreground (StateType.Insensitive));
            ...
            Controller.ChangePageEvent += delegate (PageType type) {
                Application.Invoke (delegate {
                    ...
                    case PageType.Setup:
                        ...
                        Table table1 = new Table (4, 2, true) {
                            RowSpacing = 6
                        };
                        ...
                        table1.Attach (name_label, 0, 1, 0, 1);
                        table1.Attach (NameEntry, 1, 2, 0, 1);
                        table1.Attach (email_label, 0, 1, 1, 2);
                        table1.Attach (EmailEntry, 1, 2, 1, 2);
